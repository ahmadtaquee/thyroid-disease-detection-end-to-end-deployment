...
class dBOperation:
    ...
    def __init__(self):
        ...
        self.secure_connect_bundle = 'secure-connect-thyroid-db.zip'
        self.client_id = 'PYNTJvgiABZxUYnokBeAycCh'
        self.client_secret = '_,tOru,cXLI9ORSFqiumZ89pswf6saKlalASYF8ZTkwLIJKz8ZUt_f6QRKU48-YMjvUh7dZWeSZmBw62JbzrqD8f7-9tqymZUpcaPOT8Ov6GtoN1tlYD-X6kidGBBnDU'
